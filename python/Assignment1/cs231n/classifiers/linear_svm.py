...
def svm_loss_naive(W, X, y, reg):
    ...
    Inputs:
    - W: C x D array of weights. (C: number of classes; D: image image dimension puls 1)
    - X: D x N array of data. Data are D-dimensional column vetors
